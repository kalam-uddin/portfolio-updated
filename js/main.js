...
const typedHome = new Typed('#home-typed', {
      strings: ['Data Engineer', 'Data Scientist', 'Data Analyst'],//inserting professions
      typeSpeed: 80,
      backSpeed: 80,
      backDelay: 2000,
      loop: true,
...
const sendEmail = (e) => {
    ...
    */
    ...
    emailjs.sendForm('service_jvibwao','template_frzrghg','#contact-form','3Vck1CSjGFYoG_WQ6')
    .then(() => {
        //Show sent message
